...
{Mumbai, India}
\resumeItemListStart
\resumeItem{Implemented \textbf{Acronis Cloud Protect} software with XDR, DLP, and EDR features for virus monitoring and backup setup as per client requirements, ensuring efficient data protection and cybersecurity.}
\resumeItem{Received \textbf{Acronis Professional certificate} and \textbf{Technical Associate certificate}.}
\resumeItem{Set up a company-wide CRM by configuring the CRM platform to meet the organization's specific needs, integrated the CRM with email and calendar applications and customized it to include specific fields, workflows, and reports as required.}
\resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{Software}{: Microsoft Office, Windows, Arduino IDE, Affinity Photos, Affinity Publisher, Acronis Cyber Protect Cloud } \\
