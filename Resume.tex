...
\section{Other Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Santactuz Tank Lane School}{May 2020 -- May 2021}
      {IT Consultant}{Mumbai, Maharashtra}
      \resumeItemListStart
        \resumeItem{Delivered training to school staff on the use of Microsoft Office, video conferencing platforms (e.g. Zoom, Teams) and online workflow resulting in a 90\% reduction in task completion time and an 80\% reduction in extending deadlines.}
        \resumeItem{Provided instruction for over 50 students on effective online learning methods.}
        \resumeItem{Managed all school online responsibilities and facilitated a seamless transition from in-person to online instruction.}
        \resumeItem{Digitized all documents from the previous academic year and converted offline paperwork to digital format.}
        \resumeItem{Assisted in the setup of Zoom, Google Classrooms and Google Meet for students and teachers on a regular basis.}
        \resumeItem{Documented all school events and activities for the academic year 2020-2021, and created presentations and documents for online events.}
        \resumeItem{Provided technical support for hardware and software related issues.}
        \resumeItemListEnd

    \resumeSubheading
      {SAKEC Speaker's Club}{September 2018 -- May 2019}
      {Technical Head}{Mumbai, Maharashtra}
      \resumeItemListStart
        \resumeItem{Successfully organized and managed all technical aspects for over 10 college events as the technical head.}
        \resumeItem{Coordinated with other event committee heads to gather requirements and fulfill them to ensure smooth event operation.}
        \resumeItem{Recruited and trained new students to take part in the event committee and technical team members.}
        \resumeItem{Provided leadership and direction to the technical team in executing event operations.}
    \resumeItemListEnd

    \resumeSubheading
    {SAKEC Speaker's Club Inter-College Quiz}{October 2018}
    {Technical Head}{Mumbai, Maharashtra}
      \resumeItemListStart
        \resumeItem{Successfully organized and managed all technical aspects for an intercollege quiz with over 200 participants from various colleges.}
        \resumeItem{Delegated responsibilities and ensured the smooth execution of the event.}
